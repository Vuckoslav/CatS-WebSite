...
function moveit() {
  var elem = document.getElementById("myIt");   
  var width = 10;
...
function moverec() {
  var elem = document.getElementById("myRec");   
  var width = 10;
  var id = setInterval(frame, 10);
  function frame() {
    if (width >= 50) {
...
function movefish() {
  var elem = document.getElementById("myFish");   
  var width = 10;
  var id = setInterval(frame, 10);
  function frame() {
    if (width >= 75) {
...
function moveeat() {
  var elem = document.getElementById("myEat");   
  var width = 10;
  var id = setInterval(frame, 10);
  function frame() {
    if (width >= 88) {
